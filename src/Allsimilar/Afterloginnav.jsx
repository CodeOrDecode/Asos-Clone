...
const Afterloginnav = () => {
  ...
  const { showname,handleLogout,cartcount } = React.useContext(Authcontext);
        ...
        <div className="thirdnav">
          ...
          >
            <div className="signinorjoin">
              ...
              {showname && <p className="navname">Hi {showname}</p>}
              <p className="navlogout2" onClick={handleLogout}>Sign Out</p>
